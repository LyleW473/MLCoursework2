...
from SCAN.data.augment import Augment, Cutout
from SCAN.utils.collate import collate_custom
...
def get_model(p, pretrain_path=None):
    ...
    if p['backbone'] == 'resnet18':
        if p['train_db_name'] in ['cifar-10', 'cifar-20']:
            from SCAN.models.resnet_cifar import resnet18
            backbone = resnet18()
    ...
    if p['setup'] in ['simclr', 'moco']:
        from SCAN.models.models import ContrastiveModel
